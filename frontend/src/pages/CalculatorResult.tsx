      ...
      <section className="surface-card cp-enter overflow-hidden p-5 sm:p-6">
        <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            <button onClick={goBackToCalculator} className="cp-button-secondary">Back to inputs</button>
            <button onClick={() => navigate('/')} className="cp-button-primary">Open calculator</button>
          </div>
        </div>

        <div className="mt-5 grid gap-4 2xl:grid-cols-[minmax(0,1.08fr)_minmax(360px,0.92fr)]">
      ...
      <div className="grid gap-4 2xl:grid-cols-[320px_minmax(0,1fr)]">
        <aside className="space-y-4">
          <section className="surface-card p-4">
            <div className="cp-subtle-label">Basis Snapshot</div>
            <div className="cp-heading-lg mt-2">Input basis carried into the result board</div>
          ...
          <section className="surface-card p-4">
            ...
            <div className="cp-heading-lg mt-2">Selected manufacturing steps</div>
            ...
            <section className="surface-card p-4">
              ...
              <div className="mt-4 h-[270px]">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie data={pieData} innerRadius={70} outerRadius={108} dataKey="value" paddingAngle={3} stroke="transparent">
