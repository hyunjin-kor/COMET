    ...
    <svg viewBox="0 0 512 512" fill="none" aria-hidden="true" className={className}>
      <defs>
        <linearGradient id={bgId} x1="86" y1="64" x2="426" y2="448" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="100%" stopColor="#1957c2" />
        </linearGradient>
      ...
      <rect x="54" y="54" width="404" height="404" rx="96" stroke="rgba(255,255,255,0.18)" strokeWidth="8" />
      <g opacity="0.18" stroke="#ffffff" strokeWidth="4" strokeLinecap="round">
        <path d="M156 166H356" />
        <path d="M156 214H356" />
        <path d="M156 262H356" />
        <path d="M156 310H356" />
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <g fill="#1957c2" stroke="#ffffff" strokeWidth="7">
