    ...
    <svg viewBox="0 0 512 512" fill="none" aria-hidden="true" className={className}>
      <defs>
        <linearGradient id={bgId} x1="86" y1="64" x2="426" y2="448" gradientUnits="userSpaceOnUse">
          ...
          <stop offset="100%" stopColor="#332921" />
        </linearGradient>
      ...
      <rect x="54" y="54" width="404" height="404" rx="96" stroke="#4a3d2f" strokeWidth="8" />
      <g opacity="0.14" stroke="#e5d8be" strokeWidth="4" strokeLinecap="round">
        <path d="M156 166H356" />
        <path d="M156 214H356" />
        <path d="M156 262H356" />
        <path d="M156 310H356" />
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <g fill="#1f1a14" stroke="#c96442" strokeWidth="7">
