...
## Paper methods supplement (2026-09-09)

The [current manuscript and SI](paper/README.md) now state the purchased-input mass balance, adopted thermal overhead/margin equation, structured Monte Carlo scope and candidate-set normalization explicitly. [Supplemental verification](paper/methods-2026-09-09/README.md) reproduces the arithmetic closure, same-seed thermal/area scenarios and all frozen removal controls without changing the engine. [The worked normalization example](paper/normalization-explained-2026-09-09.ko.md) separates unchanged costs from recomputed scores. Existing public yield observations supply context, not industrial cost validation.
