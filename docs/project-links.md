...
| Latest release (per package.json) | https://github.com/hyunjin-kor/CatPrice/releases/tag/v1.3.6 | Re-verify with `gh release list -L 1` before quoting |
...
- Current package version: `1.3.6`
- Python package version: `1.3.6`
- Frontend package version: `1.3.6`
- Latest verified GitHub release: `v1.3.6` (published 2026-05-08, verified via `gh release view v1.3.6` on 2026-05-08)
