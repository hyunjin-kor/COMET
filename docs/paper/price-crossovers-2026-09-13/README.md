...
Local research results, 13 September 2026; mass units converted on 14 September 2026. These figures are separate from the four figures currently embedded in the Application Note; these findings have not yet been added to the v37 manuscript. [Korean interpretation](report.ko.md).
...
| Modeled delivered cost, USD/kg | September 2025 prices | October 2025 prices |
|---|---:|---:|
| Ammonia: Co/Mg–La proxy | 8.7678 | 9.4953 |
| Ammonia: Ni/alumina proxy | 8.8910 | 8.8888 |
| Dry reforming: Ni–Co/Al–Mg proxy | 11.0956 | 11.8955 |
| Dry reforming: Ni/zeolite proxy | 11.3615 | 11.3593 |

Cobalt rises from 33.4820 to 43.1458 USD/kg while nickel changes from 15.1032 to 15.0922 USD/kg. Changing cobalt alone accounts for 0.7275 of the 0.7297 USD/kg change in the ammonia pair's cost difference, and 0.8005 of the 0.8020 USD/kg change in the dry-reforming pair's difference. Other inputs remain fixed. In October, the nickel alternative costs approximately 6.4% less than the cobalt alternative for ammonia cracking and 4.5% less for dry reforming. These are conditional model comparisons, not contemporaneous supplier quotations. The underlying full-family calculation retains all four candidates in each case.
...
- Each family uses one unit throughout: USD/cm2 for AEM and PEM OER, and USD/kg for the remaining 28 families. Powder mass is not an equivalent electrode-area or product-output basis. No cross-family cost ranking is performed. All four PEM area-cost series and three of four AEM area-cost series are constant in the monthly replay: their fixed electrode-library/default prices limit propagation of the varied metal feeds into this cost boundary. Their zero crossover counts therefore do not establish insensitivity of real electrode costs to metal markets.
...
python scripts/export_price_crossovers_kg.py --directory _local/new-replay
...
Publication figures and CSV tables use USD/kg; electrode-area costs retain USD/cm2. Conversion uses 1 lb = 0.45359237 kg and 1 troy oz = 0.0311034768 kg. Frozen engine JSON files retain original units and hashes. [Converted mechanism values](publication_mechanisms_kg.json) preserve score gaps and events, and the displayed mass-cost tie tolerance is rounded here from its exact converted value. Conversion does not remove selling margins or alter the cost boundary.
