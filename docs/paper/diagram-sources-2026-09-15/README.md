...
The export manifest records the source and output checksums. Numerical panels
are drawn by `scripts/draw_application_note_figures.py` from the separate
frozen manufacturing study. Edit the source deck and re-export; do not retouch
