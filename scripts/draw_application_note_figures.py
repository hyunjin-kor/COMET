...
TEXT = {
    "en": {
        ...
        "usd_lb": "USD/kg",
        "s2_x": "Selling price (USD/kg)", "s2_low": "Lower value", "s2_high": "Upper value",
        "s2_labels": {},
        "s3_x": "Selling price (USD/kg)", "s3_y": "Trials", "s3_mean": "Mean",
        "s3_p": "5th and 95th percentiles", "s3_b_x": "Sampled dry product mass (kg)",
    ...
    "ko": {
        ...
        "f3_c_x": "원가 차이 (%)",
        "usd_lb": "USD/kg",
        "s2_x": "판매 단가 (USD/kg)", "s2_low": "낮은 값", "s2_high": "높은 값",
        ...
        "s4_x": "스크리닝 후보 수",
        "s4_status": {"variant_available": "출처별 제조법 있음",
                      "source_mismatch": "출처/조성 불일치 확인",
                      "screening_only": "문서화된 제조법 없음"},
