...
![Figure 4. What-if analyses and observed-price crossovers. (a) Selling price versus metal loading for Ni/Al₂O₃ and Ru/Al₂O₃ prepared by incipient wetness impregnation; labels give the change per wt%. (b) Selling price versus order size; dotted lines separate the production scales. (c) Selling price of 20 wt% Ni/Al₂O₃ for five preparation procedures; other costs are materials, overheads, and margin. (d) Costs of the ammonia-cracking candidates that attain the lowest cost under {cs(monthly + '.observations')} monthly price states. (e) Conditional equal-cost boundary between {co} and {ni_al} in the nickel–cobalt price plane; points are monthly states, diamonds mark September and October 2025, and shading identifies the cheaper candidate.](figures-note-2026-09-09/fig4_decision_diagnostics.png)
