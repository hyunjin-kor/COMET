...
Alternatively, batch purchases replace composition-based materials costs, and explicit operating inputs replace Step Method processing. Electricity uses measured kWh or mean power multiplied by ramp/hold durations; gas, attended labor and equipment occupancy are costed separately. Gas time can follow an operation or its holds. Batch costs are divided by recovered dry mass in kg before overheads and an explicit margin. Missing inputs prevent calculation. Conditions, sources, formulas and cost contributions remain available in saved estimates and exports. Repeating batches assumes no scale economy; electrode records cannot use powder costing.
