...
Two to four saved cases can be compared as recorded, at common prices, and under common operating assumptions. Batch purchases, gases, and equipment share prices only through declared specification identifiers with matching units; gas reference conditions must also agree. Quantities, operation sequences, and yields remain case-specific. Shared conditions include electricity, labor, overheads, and margin. Recalculation can reflect software changes as well as prices.
