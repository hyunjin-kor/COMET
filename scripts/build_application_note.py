...
![Figure 4. Sensitivity of candidate rankings to price, weighting, candidate-set and criterion-score assumptions. (a) First-rank frequencies across the enumerated price-weight scenarios for the candidate ranked first at baseline (May 2026 prices, balanced weights and the complete candidate set), the alternative with the highest first-rank frequency, and all other candidates combined. The leading alternative is not necessarily second-ranked at the reference conditions. (b) Number of the 30 reaction families retaining the same top-ranked candidate as at baseline under each criterion: first-rank frequency ≥50% in the combined scenarios, removal of any single nonleading candidate, or the least favourable corner of the indicated criterion-score bounds. (c) Reference-price costs of the candidates ranked first at baseline (open circles) and after candidate removal (filled circles) for the nine families with a rank reversal. Costs are shown on a logarithmic axis. All surviving candidates retain their original costs; removal changes the range used for economic-score normalization. Nearly coincident markers indicate that small cost differences can accompany a change in the highest-ranked candidate. Ammonia cracking is examined in the text.](figures-note-2026-09-09/fig4_decision_diagnostics.png)
