...
![Figure 3. Decision diagnostics from the frozen study. (a) Share of joint price-state and weight scenarios in which each family's reference winner keeps first rank. (b) Families whose winner changes when one nonwinning candidate is removed, and families whose winner survives every score perturbation within the stated box. (c) Ammonia-cracking composite scores before and after removing the ruthenium candidate; every surviving cost is unchanged.](figures-note-2026-09-09/fig3_decision_diagnostics.png)
