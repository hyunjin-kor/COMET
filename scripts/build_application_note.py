...
def load_run():
    ...
    for name in (ROBUSTNESS, METHODS):
...
Figure 2 shows the inputs and the top of the result screen for a 20 wt% Ni/Al₂O₃ estimate on the live price tier, costed with the incipient-wetness impregnation template at a 20 t order. The headline price sits above a cost ledger in which each component row carries the price used, its source, quote year and reliability grade; the preparation-step table lists hourly rates, scale substitutions and operations that were left uncosted, and a costing-scope line counts them. Results export to CSV together with the price evidence and, when requested, the Monte Carlo range.

![Figure 2. Costing a 20 wt% Ni/Al₂O₃ catalyst. (a) Inputs: the formulation with the price basis of each component, the preparation template, the order size and the price tier. (b) Result screen: (1) headline price, (2) cost build-up, (3) price evidence, (4) preparation basis and (5) costing scope, which counts the operations that were priced, substituted or left uncosted.](figures-note-2026-09-09/fig2_result_screen.png)
