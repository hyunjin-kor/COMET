...
const technicalLabels = new Set(['Alt +', 'Esc', 'COMET', 'kg', 'lb', 'EN', ': Catalyst Overall Manufacturing Estimation Tool', 'cm²', '°C/min', 'mg/cm²', 'wt%', 'lb/ft³', '/hr', '/kg', '/ozt', 'FCI', 'FCI/PE', 'HS', '(DOI', 'PLOS ONE 9(7): e101298 — CC BY 4.0.']);
