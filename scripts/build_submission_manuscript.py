...
def supporting_information(run):
    ...
    lines += ["", "## Table S3. Sources, reuse limits and support series", "",
              ...
              "| CatCost publications and User Guide | Prior research; adopted thermal method and published regression cases | Academic citation; original workbook excluded; no NREL endorsement. |",
