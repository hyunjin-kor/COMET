...
| Latest Windows release | [v1.3.6](https://github.com/hyunjin-kor/CatPrice/releases/tag/v1.3.6) |
| Installer download | [CatPrice.Setup.1.3.6.exe](https://github.com/hyunjin-kor/CatPrice/releases/download/v1.3.6/CatPrice.Setup.1.3.6.exe) |
| Portable download | [CatPrice-win-unpacked.zip](https://github.com/hyunjin-kor/CatPrice/releases/download/v1.3.6/CatPrice-win-unpacked.zip) |
...
- `dist-electron\CatPrice Setup 1.3.6.exe`
